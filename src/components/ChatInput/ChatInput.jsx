            ...
            <div class="container py-5">
                ...
                <div class="row d-flex justify-content-end">
                    <div class="col-md-8 col-lg-6 col-xl-4">
                        ...
                        <a class="btn btn-primary btn-lg btn-block" data-mdb-toggle="collapse" href="#collapseExample"
                                    ...
                                    <div class="d-flex flex-row justify-content-start">
                                        ...
                                        <div>
                                            ...
                                            <p class="small p-2 ms-3 mb-1 rounded-3" style={{backgroundColor: "#f5f6f7"}}>How are you
                                                ...???</p>
                                            <p class="small p-2 ms-3 mb-1 rounded-3" style={{backgroundColor: "#f5f6f7"}}>What are you
                                                doing
