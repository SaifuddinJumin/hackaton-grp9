...
const Navbar = () => {
    ...
    return (
        ...
        <nav class="navbar navbar-expand-lg navbar-dark" style={{zIndex: 10, backgroundColor: hexColour, paddingLeft:20}}>
            <Link class="navbar-brand" to="/"><img src={process.env.PUBLIC_URL+"/pro-logo.png"} style={{width:52, marginRight:15}}/>ProCrass</Link>
